...
class BattleEffectsView {
    
    // Create a damage effect at the specified location
    static func showDamageEffect(at point: CGPoint, in view: UIView) {
        // Create particles
        for _ in 0..<20 {
    ...
    static func showHealEffect(at point: CGPoint, in view: UIView) {
        // Create particles
        for _ in 0..<15 {
    ...
    static func showShieldEffect(around targetView: UIView) {
    ...
    private static func createParticle(color: UIColor, size: CGSize) -> UIView {
